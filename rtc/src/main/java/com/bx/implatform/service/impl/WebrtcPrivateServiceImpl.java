...
public class WebrtcPrivateServiceImpl implements WebrtcPrivateService {
    ...
    private void sendActMessage(WebrtcPrivateSession rtcSession, MessageStatus status, String content) {
        ...
        // 推给发起人
        PrivateMessageVO messageInfo = toPrivateMessageVO(msg);
        IMPrivateMessage<PrivateMessageVO> sendMessage = new IMPrivateMessage<>();
    ...
    private PrivateMessageVO toPrivateMessageVO(PrivateMessage msg) {
        PrivateMessageVO vo = new PrivateMessageVO();
        vo.setId(msg.getId());
        vo.setTmpId(msg.getTmpId());
        vo.setSendId(msg.getSendId());
        vo.setRecvId(msg.getRecvId());
