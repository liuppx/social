...
.chat-message-item {
	...
	.message-tip {
		line-height: 60rpx;
		text-align: center;
		color: $yeying-text-color-lighter;
		font-size: $yeying-font-size-smaller-extra;
		padding: 10rpx;
	}
	...
	.message-normal {
		...
		.content {
			...
			.top {
				...
				.name {
					color: $yeying-text-color-lighter;
					font-size: $yeying-font-size-smaller;
					line-height: $yeying-font-size-smaller;
					height: $yeying-font-size-smaller;
					white-space: nowrap;
					overflow: hidden;
			...
			.bottom {
				...
				.message-content-wrapper {
					...
					.message-text {
						...
						margin-top: 10rpx;
						padding: 16rpx 24rpx;
						background-color: $yeying-bg;
						border-radius: 20rpx;
						color: $yeying-text-color;
						font-size: $yeying-font-size;
						text-align: left;
						display: block;
						...
						&:after {
							...
							border-color: $yeying-bg transparent transparent;
							overflow: hidden;
							border-width: 18rpx;
						}
					}
					...
					.message-image {
						...
						.image-box {
							...
							.send-image {
								cursor: pointer;
								border-radius: 10rpx;
								background: $yeying-bg;
								border: 6rpx solid $yeying-color-primary-light-5;
							}
						}

						.send-fail {
							color: $yeying-color-danger;
							font-size: $yeying-font-size;
							cursor: pointer;
							margin: 0 20px;
						}
					...
					.message-file {
						...
						.file-box {
							...
							border-radius: 4px;
							padding: 10px 15px;
							box-shadow: $yeying-box-shadow-dark;
				...
				.message-status {
					line-height: $yeying-font-size-smaller-extra;
					font-size: $yeying-font-size-smaller-extra;
					padding-top: 2rpx;
		...
		&.message-mine {
			...
			.content {
				...
				.bottom {
					...
					.message-text {
						margin-left: 10px;
						background-color: $yeying-color-primary-light-2;
						color: #fff;

						&:after {
							left: auto;
							right: -9px;
							border-top-color: $yeying-color-primary-light-2;
						}
					}
