...
.chat-record {
	.rc-wave {
		...
		.note {
			background: linear-gradient(to top, $yeying-color-primary-light-1 0%, $yeying-color-primary-light-6 100%);
			width: 4px;
			height: 50%;
			border-radius: 5rpx;
			margin-right: 4px;
			...
			@keyframes loading {
				0% {
					background-image: linear-gradient(to right, $yeying-color-primary-light-1 0%, $yeying-color-primary-light-6 100%);
					height: 20%;
					border-radius: 5rpx;
				}

				50% {
					background-image: linear-gradient(to top, $yeying-color-primary-light-1 0%, $yeying-color-primary-light-6 100%);
					height: 80%;
					border-radius: 5rpx;
				}
	...
	.chat-record-bar {
		...
		border-radius: 10rpx;
		text-align: center;
		box-shadow: $yeying-box-shadow;

		&.recording {
			background-color: $yeying-color-primary;
			color: #fff;
		}
	}
	...
	.chat-record-window {
		...
		.rc-tip {
			text-align: center;
			font-size: $yeying-font-size-small;
			color: $yeying-text-color-light;
			margin-top: 20rpx;
		}
		...
		.red {
			color: $yeying-color-danger !important;
		}
